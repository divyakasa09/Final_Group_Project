...
public class AppointmentDirectory {
    ...
    public Appointment addAppointment(Patient patient, Doctor doctor, Date aptDate, int aptHour)
    {
        Appointment apt = new Appointment(patient, doctor, aptDate, aptHour);
